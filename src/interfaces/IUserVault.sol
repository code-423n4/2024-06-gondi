...
interface IUserVault {
    ...
    /// @param _oldCollections The Old NFT collections to withdraw.
    /// @param _oldTokenIds The Old NFT token IDs to withdraw.
    ...
    /// @notice Deposit an (old) NFT into the vault.
    /// @param _vaultId The vault to deposit into.
    /// @param _collection The NFT collection.
    /// @param _tokenId The NFT token ID.
    ...
    /// @notice Deposit multiple (old) NFT into the vault.
    /// @param _vaultId The vault to deposit into.
    /// @param _collection The NFT collection.
    /// @param _tokenId The NFT token ID.
    function depositOldERC721s(uint256 _vaultId, address _collection, uint256[] calldata _tokenId) external;
    ...
    /// @notice Withdraw an NFT from the vault with an old implementation.
    /// @param _vaultId The vault to withdraw from.
    /// @param _collection The NFT collection.
    /// @param _tokenId The NFT token ID.
    ...
    /// @notice Withdraw multiple (old) NFTs.
    /// @param _vaultId The vault to withdraw from.
    /// @param _collections The NFT collections.
    /// @param _tokenIds The NFT token IDs.
