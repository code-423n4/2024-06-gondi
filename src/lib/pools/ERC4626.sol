...
abstract contract ERC4626 is ERC20 {
    ...
    constructor(ERC20 _asset, string memory _name, string memory _symbol, uint8 _decimalsOffset)
        ERC20(_name, _symbol, _asset.decimals() + _decimalsOffset)
    {
        asset = _asset;
    ...
    /// @dev Taken from OpenZeppelin 0.5
